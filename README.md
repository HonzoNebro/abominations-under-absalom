...
Version 2.0.0 is prepared for Foundry VTT 14 and PF2e 8.1.2. It intentionally does not claim support for Foundry VTT 12 or 13.
...
Publish the v2.0.0 download as a release asset named `abomination-under-absalom.zip`. The zip must contain a top-level folder named `abomination-under-absalom`, matching the module id in `module.json`.
